...
Umin=0;
pomiar_zak = 1;
a = 15; %amplituda zaklocenia, potem 15
...
%wektor przesz?‚ych przyrost??w warto?›ci zak?‚??cenia
dZpast = zeros(Dz, 1);
%aktualna zmiana zak?‚??cenia
dz=0;

zaklocenie=zeros(iterNum, 1);
...
if pomiar_zak==1
      dz=zaklocenie(k)-zaklocenie(k-1);
